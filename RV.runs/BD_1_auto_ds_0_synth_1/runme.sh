...
HD_PWD='C:/Users/AISEQ/Desktop/HT/RV/RV.runs/BD_1_auto_ds_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BD_1_auto_ds_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BD_1_auto_ds_0.tcl
