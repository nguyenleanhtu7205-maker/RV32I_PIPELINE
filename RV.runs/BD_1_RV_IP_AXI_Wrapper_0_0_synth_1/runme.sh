...
HD_PWD='C:/Users/AISEQ/Desktop/HT/RV/RV.runs/BD_1_RV_IP_AXI_Wrapper_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BD_1_RV_IP_AXI_Wrapper_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BD_1_RV_IP_AXI_Wrapper_0_0.tcl
