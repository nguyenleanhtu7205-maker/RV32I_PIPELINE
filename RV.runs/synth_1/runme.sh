...
HD_PWD='C:/Users/AISEQ/Desktop/HT/RV/RV.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BD_1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BD_1_wrapper.tcl
