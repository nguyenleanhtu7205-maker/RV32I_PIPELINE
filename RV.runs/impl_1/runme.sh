...
HD_PWD='C:/Users/AISEQ/Desktop/HT/RV/RV.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BD_1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BD_1_wrapper.tcl -notrace
